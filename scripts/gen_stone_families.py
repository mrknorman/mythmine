...
OVERRIDES = {
    ...
    "stone_button": {"minecraft:stone": TAG("raw")},
    "stone_pressure_plate": {"minecraft:stone": TAG("raw")},
    ...
    "piston": {"minecraft:cobblestone": TAG("cobbled")},
    ...
    "polished_blackstone_button": {"minecraft:polished_blackstone": TAG("polished")},
    "polished_blackstone_pressure_plate": {"minecraft:polished_blackstone": TAG("polished")},
